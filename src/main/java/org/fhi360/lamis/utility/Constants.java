...
public class Constants {
    ...
    public static class Tables {
        public static String TRANSACTION_TABLES = "monitor,user,casemanager,patient,clinic,pharmacy,laboratory," +
                "statushistory,regimenhistory,adrhistory,oihistory,adherehistory,chroniccare,dmscreenhistory," +
                "tbscreenhistory,anc,delivery,maternalfollowup,partnerinformation,specimen,eid," +
                "labno,nigqual,devolve,patientcasemanager,eac,motherinformation,child,childfollowup,biometric";
        ...
        public static String AUXILLARY_TABLES = "appointment,drugtherapy,encounter,mhtc";
    }
